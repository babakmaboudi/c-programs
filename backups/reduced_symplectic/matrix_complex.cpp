...
Matrix_Complex Matrix_Complex::operator+(Matrix mat)
{
	Matrix_Complex result;
	result.real = real + mat;
	result.imag = imag;
	return result;
}
...
void Matrix_Complex::operator+=(Matrix mat)
{
	real += mat;
}
...
{
	Matrix_Complex result;
	result.real = (real*mat.real) - (imag*mat.imag);
	result.imag = (real*mat.imag) + (imag*mat.real);
	return result;
}
...
ostream& operator<<(ostream& os,Matrix_Complex& M)
{
	cout << "---------------------";
	int ncols,nrows;
	M.real.get_size(&ncols,&nrows);
	int col_size = ncols;
	int print_col_size = 3;
...
//				cout.width(10);
				std::cout << std::setw(9);
				cout << std::setprecision(4) << M.at(j,col_offset+k,'r');
				cout << " + ";
//				cout.width(6);
				std::cout << std::setw(9);
				cout << std::setprecision(4) << M.at(j,col_offset+k,'i') << "i";
				cout << "   ";
